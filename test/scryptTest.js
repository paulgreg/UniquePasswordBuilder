...
QUnit.test(
    "check scrypt generation against https://www.grc.com/sqrl/scrypt.htm first test case",
    function (assert) {
        ...
        scrypt("", "", 9, 256, 32, function (result) {
            ...
            assert.deepEqual(
                result,
                [
                    0xa8, 0xea, 0x62, 0xa6, 0xe1, 0xbf, 0xd2, 0x0e, 0x42, 0x75,
                    0x01, 0x15, 0x95, 0x30, 0x7a, 0xa3, 0x02, 0x64, 0x5c, 0x18,
                    0x01, 0x60, 0x0e, 0xf5, 0xcd, 0x79, 0xbf, 0x9d, 0x88, 0x4d,
                    0x91, 0x1c,
                ],
                "scrypt generation problem"
            );
            done();
        });
    }
    ...
    function (assert) {
        ...
        UniquePasswordBuilder.generate(
            ...
            function (generatedPassword) {
                ...
                assert.equal(
                    generatedPassword,
                    githubTlsDefaultPassword1Round,
                    "generate problem"
                );
                assert.notEqual(
                    githubTlsDefaultPassword,
...
QUnit.test(
    "generate for https://www.google.com with 'default-password' with 512 rounds",
    function (assert) {
        var done = assert.async();
        // Given
        var algoParams = {
        ...
        UniquePasswordBuilder.generate(
            ...
            function (generatedPassword) {
                ...
                assert.equal(
                    generatedPassword,
                    googleTlsDefaultPasswordDifficulty512,
                    "generate problem"
                );
                assert.notEqual(
                    generatedPassword,
...
QUnit.test(
    "generate for https://www.google.com with 'default-password' with 2048 rounds",
    function (assert) {
        var done = assert.async();
        // Given
        var algoParams = {
        ...
        UniquePasswordBuilder.generate(
            ...
            function (generatedPassword) {
                ...
                assert.equal(
                    generatedPassword,
                    googleTlsDefaultPasswordDifficulty2048,
                    "generate problem"
                );
                assert.notEqual(
                    generatedPassword,
    ...
    function (assert) {
        ...
        UniquePasswordBuilder.generate(
            ...
            function (generatedPassword) {
                ...
                assert.equal(
                    generatedPassword,
                    googleTlsDefaultPasswordOldKeyIndex1,
                    "generate problem"
                );
                assert.notEqual(
                    generatedPassword,
    ...
    function (assert) {
        ...
        UniquePasswordBuilder.generate(
            ...
            function (generatedPassword) {
                ...
                assert.equal(
                    generatedPassword,
                    googleTlsDefaultPasswordOldKeyIndex2,
                    "generate problem"
                );
                assert.notEqual(
                    generatedPassword,
    ...
    function (assert) {
        ...
        UniquePasswordBuilder.generate(
            ...
            function (generatedPassword) {
                ...
                assert.equal(
                    generatedPassword,
                    googleTlsDefaultPasswordUserSaltSomething,
                    "generate problem"
                );
                assert.notEqual(
                    generatedPassword,
